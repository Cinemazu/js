...
function appendLogo(e, t) {
    ...
    } else "kd" == t || "ni" == t ? a <= 480 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 1%; width: 24%; height: 16%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 100; margin-left: 0%; margin-top: 0%; width: 0%; height: 0%; min-height: 0px; min-width: 0px; background-image: url(\'' + imgReq + "/404');\"></div>") : "nn" != t && "sakizu" != t && "skz" != t || (a <= 360 ? e < 2 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 100; margin-left: 0%; margin-top: 0%; width: 0%; height: 0%; min-height: 0px; min-width: 0px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 0.5%; width: 22%; height: 13%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : a <= 1080 && (e < 2 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 0.5%; width: 24%; height: 12%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.4%; margin-top: 0.4%; width: 24%; height: 12%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>")));
