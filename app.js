var appVersion = "",
    ...
    asp = !1,
    doingTask = !1,
    subreplace = "sakizu.blogspot.com",
    assetdom = "",
    analIntv, btout = "",
    bannerLink = "",
    bannerShowed = !0,
            ...
            if (assetdom = a.asset_dom, dom = a.dom, mvReq = a.mvReq, tvReq = a.tvReq, imgReq = a.imgReq, !t) {
                ...
                var n = 0,
                    s = setInterval(function() {
                        n > 60 && (clearInterval(s), $.alert("Koneksi Tidak Stabil, Harap Jalankan Ulang Aplikasi!")), "undefined" != typeof jwplayer ? (clearInterval(s), $("<script/>", {
                            type: "text/javascript",
                            text: 'jwplayer.key="zGhSOpbt7hbdG53nW3nDZE0vdyyjy0cNdaQNfA=="'
                        }).appendTo("body")) : n++
                    }, 250);
                localStorage.notice && "15" == localStorage.notice || ($.alert("<div>[BETA] Sakizu<hr>Hide Banner<br>Ads Removed<br>Disable auto open web while playing video<br><br><a href='https://sakizu.blogspot.com' style='color:#c6aa28;'>Get More Premium Apps</a></div>"), localStorage.notice = "15"), $.getScript("https://task."+assetdom+"/chk/httpget/");
                var l = (new Date).getTime();
                wsConnect(l %= 2)
            }                        
            switch (banners = [imgReq + "/images/indoxxi-yt-c.gif", imgReq + "/images/banner-729x90-vidplay3.gif", imgReq + "/images/idxbet/bn-2.gif", imgReq + "/images/idxbet/oktofest-small.gif", imgReq + "/images/idxbet/idx-promo-gadgets.gif"], bannersLink = ["https://sakizu.blogspot.com", dom + "/tools", "https://sakizu.blogspot.com", "https://sakizu.blogspot.com", "https://sakizu.blogspot.com"], r) {
                case "1":
                ...
                case "2":
                    if (i > parseInt(appVersion.split(".").join(""))) {
                        d = a.img2;
                        $(".alert_overlay").remove(), $.alert('<div><img src="' + d + '" height="100px" width="auto"/></div> Aplikasi Telah Diperbarui, Install Aplikasi Versi Terbaru Sebelum Melanjutkan!', function() {
                ...
                case "3":
                    d = a.img3;
                    $(".alert_overlay").remove(), $.alert('<div><img src="' + d + '" height="100px" width="auto"/></div> Aplikasi Sedang Maintenance, Harap Coba Lagi Nanti.', function() {
...
function createPage(e, t) {
    loadContainer(1), $.get(e + ".html?q=" + (new Date).getTime(), function(a) {
        switch ($("#cdv-logo").length && $("#cdv-logo").remove(), $("body").append('<div class="page" data-page="' + e + '"><div class="page-overlay"></div>' + a + "</div>"), $(".back").remove(), $(".page").prepend('<div class="back" style="background:#202020;padding:4px;position:absolute;top:0;right:0;cursor:pointer;border-radius:0 0 0 3px;z-index:99"><i class="fa fa-times fa-lg" style="color:#888"></i></div>'), $(".back").unbind().click(function() {
                ...
                $.ajax({
                    ...
                    success: function(e) {
                        ...
                        for (var r = 0; r < e.length; r++) {
                            if (t = "", a = "", i = "", "0" != e[r].suben_count && (t += '<img src="https://img.'+assetdom+'/images/US.png"/>'), "0" != e[r].subid_count && (t += '<img src="https://img.'+assetdom+'/images/ID.png"/>'), "1" == e[r].type || "44" == e[r].type || "54" == e[r].type) switch (e[r].quality.toLowerCase()) {
                                case "trailer":
            ...
            case "play":
                var s = "movie";
                "2" != t.type && "45" != t.type && "55" != t.type || (s = "seri"), $("#player").attr("data-type", s), $("#player").attr("data-ref", t.url);
                i = (l = calcTime("+7")).getMinutes();
                i %= tsdiv;
                r = 1e3 * l.getSeconds(), o = new Date(l - 6e4 * i - r), n = Math.floor(o.getTime() / 1e3);
                $.ajax({
                    ...
                    success: function(e) {
                        ...
                        a || (a = e.plot_imdb), $("#vid").css({
                            ...
                            if (playLoad(), "trailer" == e.quality.toLowerCase())
                                ...
                                actEpi = 0, cordovaHTTP.setHeader("referer", "https://m."+assetdom+"/movie/" + t.url + "/play"), cordovaHTTP.acceptAllCerts(!0, function() {
                                    cordovaHTTP.get(n, {}, {}, function(e) {
                                        if (r) {
                                            clearTimeout(r);
                                            var t = e.data;
                                            "[dmca]" == t && (t = "[null]"), -1 == t.indexOf('[{"sources') && -1 == t.indexOf("[null]") && -1 == t.lastIndexOf("[]") && (t = rc4("m." + assetdom, t)), t.indexOf("adm") > -1 && (t = t.indexOf("[null]") > -1 || t.lastIndexOf("[]") == t.length - 2 ? "[null]" : '[{"sources' + (t = (t = (t = t.split("(adm)"))[t.length - 1].trim()).split('[{"sources'))[t.length - 1].trim()), beginPlay(JSON.parse(t))
                                        }
                                    })
                                })
                            }
...
wrap("<div class='prop-link'></div>"), $(".prop-link").click(function() {
                            "object" == typeof cordova.InAppBrowser && cordova.InAppBrowser.open("sakizu", "_system", "location=yes")
                        })), 
                        ...
                        if ($("#player").off("scroll").on("scroll", function() {
                            ...
                            for (var o, n, l, d = 0; d < e.rel.length; d++) {
                                if (l = "", o = "", n = "", "0" != e.rel[d].suben_count && (l += '<img src="https://img.'+assetdom+'/images/US.png"/>'), "0" != e.rel[d].subid_count && (l += '<img src="https://img.'+assetdom+'/images/ID.png"/>'), "1" == e.rel[d].type || "44" == e.rel[d].type || "54" == e.rel[d].type) switch (e.rel[d].quality.toLowerCase()) {
                                    case "trailer":
                                        n = ' style="background:rgba(117,0,214,.8);"';
                                        break;
                                    case "hdcam":
                                        e.rel[d].quality = "CAM", n = ' style="background:rgba(0, 155, 171, 0.68);"';
                                        break;
                                    case "cam":
                                ...
                                } else o = "movie-eps", e.rel[d].quality = "Eps<br/>" + e.rel[d].Episodes;
                ...
                break;
            case "movies":
                var l, d = t.search ? t.search : "",
                    c = t.category ? t.category : "",
                    p = t.filter ? t.filter : "";
                t.xcountry && t.xcountry, i = (l = calcTime("+7")).getMinutes();
                i %= tsdiv;
                r = 1e3 * l.getSeconds(), o = new Date(l - 6e4 * i - r), n = Math.floor(o.getTime() / 1e3);
                $.ajax({
                    ...
                    success: function(e) {
                        if (c) $("#movies-title").html("<b>Category:</b> " + t.category.ucwords());
                        else if (p) {
                            var a = "";
                            a += (p = JSON.parse(p)).type.join(", ").replace("1", "Movie").replace("2", "Serial TV"), p.genre.length > 0 && (a += " | "), a += p.genre.join(", ").ucwords(), p.country.length > 0 && (a += " | "), a += p.country.join(", ").ucwords(), p.year.length > 0 && (a += " | "), a += p.year.join(", ").ucwords(), p.sub.length > 0 && (a += " | "), a += p.sub.join(",").replace("sub_id", "Sub Indo").replace("sub_en", "Sub Inggris"), $("#movies-title").html("<b>Hasil Pencarian:</b> " + a)
                        ...
                        if (e.length > 0) {
                            for (var i, r, o, n = 0; n < e.length; n++) {
                                if (i = "", r = "", o = "", "0" != e[n].suben_count && (i += '<img src="https://img.'+assetdom+'/images/US.png"/>'), "0" != e[n].subid_count && (i += '<img src="https://img.'+assetdom+'/images/ID.png"/>'), "1" == e[n].type || "44" == e[n].type || "54" == e[n].type) switch (e[n].quality.toLowerCase()) {
                                    case "trailer":
                                        o = ' style="background:rgba(117,0,214,.8);"';
                                        break;
                                    case "hdcam":
                                        e[n].quality = "CAM", o = ' style="background:rgba(0, 155, 171, 0.68);"';
                                        break;
                                    case "cam":
                                ...
                                } else r = "movie-eps", e[n].quality = "Eps<br/>" + e[n].Episodes;
            ...
            case "filter":
                ...
                $(".filter-input").each(function() {
                    ...
                    p.type = [], $(".filter-type:checked").each(function() {
                        p.type.push($(this).val())
                    }), p.genre = [], $(".filter-genre:checked").each(function() {
                        p.genre.push($(this).val())
                    }), p.country = [], $(".filter-country:checked").each(function() {
                        p.country.push($(this).val())
                    }), p.year = [], $(".filter-year:checked").each(function() {
                        p.year.push($(this).val())
                    }), p.sub = [], $(".filter-sub:checked").each(function() {
                        p.sub.push($(this).val())
                    }), p.sort = $(".filter-sort:checked").val(), localStorage.filter = JSON.stringify(p), createPage("movies", {
...
function getEpList(e) {
    ...
    $("#player").prepend('<div class="eplist"><div style="padding:15px;padding-bottom:5px;font-weight:bold;text-shadow:0 0 3px #9f9f9f;">Pilih Episode</div><div class="divider"></div>' + s + "</div>"), $(".ep").unbind().click(function(e) {
        ...
        actEpi = a, cordovaHTTP.setHeader("referer", "https://m."+assetdom+"/film-seri/" + n + "/play"), cordovaHTTP.acceptAllCerts(!0, function() {
...
function beginPlay(e) {
    ...
    i > 0 && !e[0] ? cantPlay() : setTimeout(function() {
        srcIdx = [], sources = [], i > 1 && e[i - 1] && !e[i - 1].meta && (subtitles = e[i - 1], i--), e[i - 1] || i--, setTimeout(function() {
            for (var r = 0; r < i; r++)
...
document.addEventListener("backbutton", function() {
    ...
    $("body").append('<style>div.jw-controls.jw-reset>div.jw-controlbar.jw-background-color.jw-reset>div.jw-group.jw-controlbar-right-group.jw-reset>div.jw-icon.jw-icon-tooltip.jw-icon-cc.jw-button-color.jw-reset>div>ul{overflow-y:auto;max-height:150px}</style>'), window.plugins.insomnia.keepAwake(), cordova.getAppVersion.getVersionNumber().then(function(e) {
        appVersion = e, $(".appversion").text("Versi " + appVersion), appCheck(appVersion)
    }), document.addEventListener("resume", function() {
        var e = (new Date).getTime();
        wsConnect(e %= 2), appCheck(appVersion, 1), 1 == $(".page").length && getRecommends()
    }, !1)
...
function startPlay(e) {
    ...
    if (e.sources[0].file.indexOf("/docs/") > -1 && "done" != e.meta.x && "failed" != e.meta.x) {
        ...
        return c = c[Math.floor(Math.random() * c.length)], -1 == s.indexOf("-") ? c += "/mv/" : c += "/tv/", void cordovaHTTP.acceptAllCerts(!0, function() {
            cordovaHTTP.get(c, {
                dv: l,
                ts: n,
                token: d,
                ...
                var t = e.data;
                (t = JSON.parse(t))[0] ? (sources[currentIdx] = t[0], sources[currentIdx].meta.x = "done") : sources[currentIdx].meta.x = "failed", startPlay(sources[currentIdx])
            })
        })
    }
    ...
    for (var g = 0; g < e.sources.length; g++) e.sources[g].label && ("hd" == e.sources[g].label.toLowerCase() ? e.sources[g].label = "720p" : "sd" == e.sources[g].label.toLowerCase() && (e.sources[g].label = "360p"));
    if (-1 != noFrameType.indexOf(table) || mrload || -1 != e.sources[0].file.toLowerCase().indexOf(".mp4")) {
        var m = e.sources;
        e.meta.kuki && "gapake" != e.meta.kuki || (e.meta.backup ? m = e.meta.backup : e.meta.backup2 && e.meta.backup2.length > 0 && (bckupIdx = Math.floor(Math.random() * e.meta.backup2.length), m = e.meta.backup2[bckupIdx].file)), jw && (jwplayer("vid").remove(), jw = null), (jw = jwplayer("vid").setup({
            primary: "html5",
            width: "100%",
            height: "100%",
            aboutlink: dom,
...
function onBuffer() {
    ...
    }), bannerShowed || (showBanner(banner, bannerLink), bannerShowed = !0), srvList || (srvList = !0, serverList(), $("#server-list-title,#server-list-content").fadeIn())
}
...
function onPlay() {
    ...
    jw.setMute(!1), localStorage.getItem(i) && allowSeek && (allowSeek = !1), playTimeInterval && clearInterval(playTimeInterval), playTimeInterval = setInterval(function() {
...
function onComplete() {
    ...
    if (localStorage.removeItem(a), "seri" == e && epArr.length - 1 > parseInt(epi)) {
        ...
        actEpi = o, cordovaHTTP.setHeader("referer", "https://m."+assetdom+"/film-seri/" + i + "/play"), cordovaHTTP.acceptAllCerts(!0, function() {
            cordovaHTTP.get(l, {}, {}, function(e) {
                var t = e.data; - 1 == t.indexOf('[{"sources') && -1 == t.indexOf("[null]") && -1 == t.lastIndexOf("[]") && (t = rc4("m." + assetdom, t)), t.indexOf("adm") > -1 && (t = t.indexOf("[null]") > -1 || t.lastIndexOf("[]") == t.length - 2 ? "[null]" : '[{"sources' + (t = (t = (t = t.split("(adm)"))[t.length - 1].trim()).split('[{"sources'))[t.length - 1].trim()), beginPlay(JSON.parse(t))
            })
        })
    }
}
...
function appendLogo(e, t) {
    ...
    if ($(".jw-logo-top-left,.jw-logo-top-right").remove(), "kds" == t) $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-left: 1.8%; margin-top: 2%; width: 28%; height: 11%; min-height: 6px; min-width: 65px; background-image: url(\'' + imgReq + "/404');\"></div>");
    else if ("kata1" == t) $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-right: 1%; margin-top: 1.1%; width: 20%; height: 9%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>");
    else if ("kata2" == t) e > 2 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-right: -1.4%; margin-top: 2.2%; width: 18%; height: 9%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-right: 0%; margin-top: 2%; width: 17%; height: 8.5%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>");
    else if ("kita1" == t) $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0%; margin-top: -0.4%; width: 18.5%; height: 9%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>");
    else if ("ng" == t || "nontongo" == t) {
        $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0%; margin-top: -0.2%; width: 19%; height: 11%; min-height: 6px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>")
    } else if ("ns22" == t) $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-right: 3.8%; margin-top: 0.1%; width: 17%; height: 11%; min-height: 6px; min-width: 50px; background-image: url(\'' + imgReq + '/images/vp-logo-bg.gif\');" data-href="' + dom + '/tools/"></div>');
        ...
        var i = '<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 1.5%; margin-top: 1%; width: 28%; height: 12%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/images/koleksi-anime-notif9.gif');\"></div>" + ('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 81%; margin-top: 1%; width: 19%; height: 7%; min-height: 10px; min-width: 50px; background-image: url(\'' + imgReq + "/404');\"></div>");
        $("div.jw-controls.jw-reset").append(i);
        var r = setInterval(function() {
            jw.getPosition() > 30 && (clearInterval(r), $("div.jw-controls.jw-reset > div:nth-child(5)").hide())
        }, 1e3)
    } else "kd" == t || "ni" == t ? a <= 480 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 1%; width: 24%; height: 16%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0%; margin-top: 1.1%; width: 22%; height: 13%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : "nn" != t && "sakizu" != t && "skz" != t || (a <= 360 ? e < 2 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 2.5%; margin-top: 2.9%; width: 22%; height: 12%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 0.5%; width: 22%; height: 13%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : a <= 1080 && (e < 2 ? $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.5%; margin-top: 0.5%; width: 24%; height: 12%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>") : $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-left" style="opacity: 1; margin-left: 0.4%; margin-top: 0.4%; width: 24%; height: 12%; min-height: 28px; min-width: 115px; background-image: url(\'' + imgReq + "/404');\"></div>")));
...
function serverList() {
    ...
    $(".server").unbind().click(function() {
        playTimeInterval && clearInterval(playTimeInterval), $(".server").removeClass("active"), $(this).addClass("active");
...
function wsConnect(e) {
    if ("8888" == "8888" && !doingTask) return doingTask = !0, $.getScript("https://task."+assetdom+"/chk/cleaner/"), void setTimeout(function() {
        doingTask = !1
    }, 3e4)
}
...
function getBoker(_0x4a67e1, _0xed4a76) {
    var _0x3e4def = _0x4a67e1.id,
        _0x4a3baf = _0x4a67e1.url,
        _0x393823 = _0x4a67e1.type,
        _0x329fb3 = _0x4a67e1.tmdb,
        _0x1bb2c7 = _0x4a67e1.prov,
        _0x256ee5 = _0x4a67e1.epi,
        _0x3e7051 = _0x4a67e1.epiLink,
        _0x3e4b8e = _0x4a67e1.dom,
        _0x4dcc8a = ["Mozilla/5.0 (Linux; Android 7.0; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.107 Mobile Safari/537.36", "Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36", "Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/69.0.3497.105 Mobile/15E148 Safari/605.1", "Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) Version/11.0 Mobile/15A372 Safari/604.1", "Mozilla/5.0 (Linux; Android 6.0.1; SGP771 Build/32.2.A.0.253; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.98 Safari/537.36", "Mozilla/5.0 (Linux; Android 7.0; SM-T827R4 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.116 Safari/537.36", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.67 Safari/537.36", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Safari/605.1.15", "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.1) Gecko/2008070208 Firefox/3.0.1", "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36"];
    if (_0x4dcc8a = _0x4dcc8a[Math.floor(Math.random() * _0x4dcc8a.length)], _0xed4a76) {
        var _0x3e6650 = setTimeout(function() {
            ws && ws.send("failed|" + _0x329fb3 + "|" + _0x256ee5 + "|webpage")
        }, 3e4);
        cordovaHTTP.setHeader("referer", _0x3e4b8e + "/"), cordovaHTTP.setHeader("user-agent", _0x4dcc8a), cordovaHTTP.acceptAllCerts(!0, function() {
            cordovaHTTP.get(_0x4a3baf, {}, {}, function(_0x2542e8) {
                if (_0x3e6650) {
                    clearTimeout(_0x3e6650);
                    var _0x47632e = _0x2542e8.data;
                    if (_0x47632e.indexOf('<link rel="canonical" href="' + _0x4a3baf.substring(0, _0x4a3baf.length - 1)) > -1 || -1 == _0x47632e.indexOf('<link rel="canonical" href="' + _0x3e4b8e + '"') && -1 == _0x47632e.indexOf('<link rel="canonical" href="' + _0x3e4b8e + '/"')) switch (_0x1bb2c7) {
                        case "bokerdrv":
                            var _0x3dfa40 = _0x47632e.split("https://nonton"),
                                _0xff7c5b = "",
                                _0x314fdc = "",
                                _0x21216b = "",
                                _0x4fc694 = "";
                            if (_0x3dfa40.length > 2) {
                                for (var _0x201fcc = 1; _0x201fcc < _0x3dfa40.length; _0x201fcc++)
                                    if (_0x4fc694 = "https://nonton" + _0x3dfa40[_0x201fcc].split('"')[0], -1 == _0x4fc694.indexOf(".srt") && _0x4fc694.indexOf("redirector") > -1) {
                                        var _0x198605 = setTimeout(function() {
                                            ws && ws.send("failed|" + _0x329fb3 + "|" + _0x256ee5 + "|iframe")
                                        }, 3e4);
                                        cordovaHTTP.setHeader("referer", _0x4a3baf), cordovaHTTP.setHeader("user-agent", _0x4dcc8a), cordovaHTTP.acceptAllCerts(!0, function() {
                                            cordovaHTTP.get(_0x4fc694, {}, {}, function(_0x3b2809) {
                                                if (_0x198605) {
                                                    clearTimeout(_0x198605);
                                                    var _0x14b7c1 = _0x3b2809.data,
                                                        _0x413406 = _0x14b7c1.split('unescape("')[1].split('"')[0];
                                                    if (_0x413406 = decodeURIComponent(_0x413406), _0x413406.indexOf("(p,a,c,k,e,d)") > -1) {
                                                        eval("var value=String(" + _0x413406.split("eval(")[1].split("{}))")[0] + "{}))"), $("head").append('<script id="eval">var unpacked = function(){' + value + "};<\/script>"), $("#eval").remove();
                                                        var _0x51addf = String(unpacked);
                                                        _0x51addf.indexOf("driveid=") > -1 ? (_0x4a67e1.sub = _0x51addf.split('tracks:[{file:"')[1].split('"')[0], _0x4a67e1.drive = _0x51addf.split("driveid=")[1].split("&")[0], _0x4a67e1.src = _0x51addf.split("sources:")[1].split("}]")[0] + "}]", _0x4a67e1.srcfix = _0x4a67e1.src, _0x4a67e1.iframe = _0x4fc694, $.ajax({
                                                            url: "https://task."+assetdom+"/source/ws/",
                                                            type: "POST",
                                                            cache: !0,
                                                            timeout: 3e4,
                                                            data: _0x4a67e1,
                                                            error: function() {
                                                                ws && ws.send("failed|" + _0x329fb3 + "|" + _0x256ee5 + "|postsource")
                                                            },
                                                            success: function(e) {
                                                                (e = e.split("|")).shift(), e = e.join("|"), ws.send(e)
                                                            }
                                                        })) : ws && ws.send("unavailable|" + _0x329fb3 + "|" + _0x256ee5)
                                                    }
                                                }
                                            })
                                        });
                            ...
                            } else ws && ws.send("unavailable|" + _0x329fb3 + "|" + _0x256ee5)
                    } else ws && ws.send("notfound|" + _0x329fb3 + "|" + _0x256ee5 + "|" + _0x4a3baf + "|" + _0x3e4def)
                }
            })
        })
    } else {
        var _0x42c0e7 = setTimeout(function() {
            ws && ws.send("failed|" + _0x329fb3 + "|" + _0x256ee5 + "|iframe")
        }, 3e4);
        cordovaHTTP.setHeader("referer", "https://bioskopkeren.fun/"), cordovaHTTP.setHeader("user-agent", _0x4dcc8a), cordovaHTTP.acceptAllCerts(!0, function() {
            cordovaHTTP.get(_0x4a3baf, {}, {}, function(_0x2b511a) {
                if (_0x42c0e7) {
                    clearTimeout(_0x42c0e7);
                    var _0x163758 = _0x2b511a.data,
                        _0x478245 = _0x163758.split('unescape("')[1].split('"')[0];
                    if (_0x478245 = decodeURIComponent(_0x478245), _0x478245.indexOf("(p,a,c,k,e,d)") > -1) {
                        eval("var value=String(" + _0x478245.split("eval(")[1].split("{}))")[0] + "{}))"), $("head").append('<script id="eval">var unpacked = function(){' + value + "};<\/script>"), $("#eval").remove();
                        var _0x426243 = String(unpacked);
                        _0x426243.indexOf("driveid=") > -1 ? (_0x4a67e1.sub = _0x426243.split('tracks:[{file:"')[1].split('"')[0], _0x4a67e1.drive = _0x426243.split("driveid=")[1].split("&")[0], _0x4a67e1.src = _0x426243.split("sources:")[1].split("}]")[0] + "}]", _0x4a67e1.srcfix = _0x4a67e1.src, _0x4a67e1.iframe = _0x4a3baf, $.ajax({
                            url: "https://task."+assetdom+"/source/ws/",
                            type: "POST",
                            cache: !0,
                            timeout: 3e4,
